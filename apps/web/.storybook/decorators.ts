 ...
 *
 * NOTE: This file is loaded by preview.ts in CJS/esbuild-register context (not the browser).
 * Story files must NOT import from this path — use $lib/stores/auth.js directly instead.
 */
